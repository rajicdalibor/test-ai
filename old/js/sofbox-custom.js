  ...
  jQuery(document).ready(function () {
    jQuery(window).on("load", function (e) {
      ...
      $(".scroll-link").on("click", function (e) {
        ...
        e.preventDefault();
        $(".navbar-nav li a[href='#iq-feature']").addClass("active");
        $(".navbar-nav li a[href='#iq-home']").removeClass("active");
      });
    ...
    --------------------------*/
      ...
      /*------------------------
                About-style
            --------------------------*/
      $(".effect-box .effect-btn").click(function () {
      ...
      //     src: "https://calendly.com/thomas-veit/ai-in-a-box-30min-call?month=2021-09",
      //   });
      // });
    ...
    function animateElements() {
      jQuery(".progressbar-circle").each(function () {
        ...
        if (
          elementPos < topOfWindow + jQuery(window).height() - 30 &&
          !animate
        ) {
